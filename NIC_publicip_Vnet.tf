# This Terraform configuration for azure provider
terraform {
  required_providers {
    azurerm = {
...
# This creates a network interface card (NIC) in the first subnet
...
#depends_on ensures that the resource group is created before the public IP
